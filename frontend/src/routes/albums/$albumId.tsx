...
const AlbumPlayButton = observer(({ album }: albumPlayButtonProps) => {
	...
	return (
		<div className="relative grid w-48 items-center justify-items-center overflow-hidden rounded-lg">
			...
			/>
			<button
				className="col-start-1 row-start-1 flex h-full w-full items-center justify-center text-white drop-shadow-lg hover:text-primary hover:backdrop-brightness-95 active:brightness-90 [&>svg]:hover:text-current"
				onClick={() => {
					if (
