...
import { Route as AdminAlbumsIndexImport } from './routes/admin/albums/index'
import { Route as AdminArtistsArtistIdImport } from './routes/admin/artists/$artistId'
import { Route as AdminAlbumsAlbumIdImport } from './routes/admin/albums/$albumId'
...
const AdminAlbumsIndexRoute = AdminAlbumsIndexImport.update({
  path: '/albums/',
  getParentRoute: () => AdminRoute,
} as any)
...
const AdminAlbumsAlbumIdRoute = AdminAlbumsAlbumIdImport.update({
  path: '/albums/$albumId',
  getParentRoute: () => AdminRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/admin/albums/': {
      preLoaderRoute: typeof AdminAlbumsIndexImport
      parentRoute: typeof AdminImport
    }
    '/admin/artists/': {
...
export const routeTree = rootRoute.addChildren([
  ...
  AdminRoute.addChildren([
    AdminUploadRoute,
    AdminAlbumsAlbumIdRoute,
    AdminArtistsArtistIdRoute,
    AdminAlbumsIndexRoute,
